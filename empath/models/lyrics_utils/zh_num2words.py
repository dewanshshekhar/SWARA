...
class ChineseChar(object):
    """
    Chinese characters
    Each character corresponds to simplified and traditional,
    e.g. Simplified = 'negative', Traditional = 'negative'
    can be converted to simplified or traditional during conversion
    """
...
class ChineseNumberUnit(ChineseChar):
    """
    Chinese numbers/digit characters
    each character has an additional uppercase character besides simplified and traditional
    e.g. 'six' and 'six'
    """
...
class MathSymbol(object):
    """
    Mathematical symbols used in Chinese number system (Traditional/Simplified), e.g.
    positive = ['正', '正']
    negative = ['负', '負']
    point = ['点', '點']
    """
...
def create_system(numbering_type=NUMBERING_TYPES[1]):
    """
    Return and create the corresponding number system according to the number system type, default is mid
    NUMBERING_TYPES = ['low', 'mid', 'high']: Chinese number system types
        low:  '兆' = '亿' * '十' = $10^{9}$,  '京' = '兆' * '十', etc.
        mid:  '兆' = '亿' * '万' = $10^{12}$, '京' = '兆' * '万', etc.
        high: '兆' = '亿' * '亿' = $10^{16}$, '京' = '兆' * '兆', etc.
    Return the corresponding number system
    """
...
def chn2num(chinese_string, numbering_type=NUMBERING_TYPES[1]):
    ...
    def correct_symbols(integer_symbols, system):
        """
        one hundred and eight to one hundred and eighty
        one hundred and thirteen million to one hundred million ten million three million
        """
...
def normalize_nsw(raw_text):
    ...
    # Standardize landline/mobile number
    # Mobile
    # http://www.jihaoba.com/news/show/13680
    # Mobile: 139, 138, 137, 136, 135, 134, 159, 158, 157, 150, 151, 152, 188, 187, 182, 183, 184, 178, 198
    # Unicom: 130, 131, 132, 156, 155, 186, 185, 176
    # Telecom: 133, 153, 189, 180, 181, 177
    ...
    # Standardize pure number + quantifier
...
def remove_erhua(text):
    """
    Remove erhua in words:
    Her daughter is over there -> Her daughter is over there
    """
