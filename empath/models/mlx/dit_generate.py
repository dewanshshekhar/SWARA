# MLX diffusion generation loop for Empath DiT decoder.
#
# Replicates the timestep scheduling and ODE/SDE stepping from
# ``EmpathConditionGenerationModel.generate_audio`` using pure MLX arrays.
...
# Pre-defined timestep schedules (from modeling_empath_v15_turbo.py)
