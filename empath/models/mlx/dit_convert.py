# Weight conversion from PyTorch Empath DiT decoder to native MLX format.
...
def convert_decoder_weights(
    ...
    ``pytorch_model.decoder`` (``EmpathDiTModel``) and converts them to MLX
    format, handling:
    ...
    Args:
        pytorch_model: The full ``EmpathConditionGenerationModel`` (PyTorch).
