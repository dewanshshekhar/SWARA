...
from empath.core.generation.handler import (
    AudioCodesMixin,
    BatchPrepMixin,
...
class EmpathHandler(
    ...
    def __init__(self):
        ...
        self.disable_tqdm = os.environ.get("EMPATH_DISABLE_TQDM", "").lower() in ("1", "true", "yes") or not getattr(sys.stderr, 'isatty', lambda: False)()
        self.debug_stats = os.environ.get("EMPATH_DEBUG_STATS", "").lower() in ("1", "true", "yes")
