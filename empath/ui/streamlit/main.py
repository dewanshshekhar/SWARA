...
st.set_page_config(
    ...
    menu_items={
        "Get Help": (
            "https://github.com/empath/Empath-1.5"
        ),
        "Report a bug": (
            "https://github.com/empath/Empath-1.5/issues"
        ),
        "About": (
...
<style>
    ...
    .stApp {
        background: linear-gradient(-45deg, #1a0b2e, #4b1d52, #182848, #0b1d2e);
    ...
    /* Glass Panels */
    .block-container, section[data-testid="stSidebar"], div[data-testid="stForm"] {
    ...
    /* Ensure tabs look like glass pills */
...
<div style="text-align: center; color: #888; font-size: 0.85rem;">
    <p>
        ...
        Powered by
        <a href="https://github.com/empath/Empath-1.5">
        Empath</a> |
