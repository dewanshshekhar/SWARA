...
A modern, user-friendly Streamlit interface for [Empath v1.5](https://github.com/empath/Empath-1.5) music generation.
...
- 🌍 [Empath Website](https://empath.github.io/)
...
- 🐙 [GitHub Repository](https://github.com/empath/Empath-1.5)
