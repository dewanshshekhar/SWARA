...
class TrainingDecompositionContractTests(unittest.TestCase):
    ...
    def test_training_facade_imports_tab_helpers(self) -> None:
        ...
        self.assertIn(
            "empath.ui.gradio.interfaces.training_dataset_builder_tab",
            imported_modules,
        )
        self.assertIn("empath.ui.gradio.interfaces.training_lora_tab", imported_modules)
        self.assertIn("empath.ui.gradio.interfaces.training_lokr_tab", imported_modules)
    ...
    def test_training_ui_markers_preserved(self) -> None:
        ...
        expected_markers = {
            "training.py": ["🎵 LoRA Training for Empath"],
        ...
        for module_name in (
            ...
            for node in ast.walk(module):
                if (
                    ...
                    and node.module == "empath.ui.gradio.i18n"
