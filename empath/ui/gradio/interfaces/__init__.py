...
"""
import gradio as gr
from empath.ui.gradio.i18n import get_i18n, t
from empath.ui.gradio.interfaces.dataset import create_dataset_section
from empath.ui.gradio.interfaces.generation import (
    create_advanced_settings_section,
    create_generation_tab_section,
)
from empath.ui.gradio.interfaces.audio_player_preferences import (
    get_audio_player_preferences_head,
)
from empath.ui.gradio.interfaces.result import create_results_section
from empath.ui.gradio.interfaces.training import create_training_section
from empath.ui.gradio.events import setup_event_handlers, setup_training_event_handlers
from empath.ui.gradio.help_content import create_help_button, HELP_MODAL_CSS
