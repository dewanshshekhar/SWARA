...
from empath.constants import DEBUG_TRAINING
from empath.ui.gradio.interfaces.training_dataset_builder_tab import (
    create_dataset_builder_tab,
)
from empath.ui.gradio.interfaces.training_lokr_tab import create_training_lokr_tab
from empath.ui.gradio.interfaces.training_lora_tab import create_training_lora_tab
...
def create_training_section(dit_handler, llm_handler, init_params=None) -> dict:
    ...
    <div style="text-align: center; padding: 10px; margin-bottom: 15px;">
        <h2>🎵 LoRA Training for Empath</h2>
