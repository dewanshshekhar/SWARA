...
@patch("empath.ui.gradio.events.results.batch_navigation.gr")
@patch("empath.ui.gradio.events.results.batch_navigation.t", side_effect=lambda key, **kw: key)
class NavigateToNextBatchTests(unittest.TestCase):
    ...
    def test_stale_total_batches_allows_navigation(self, _mock_t, mock_gr):
        ...
        from empath.ui.gradio.events.results.batch_navigation import navigate_to_next_batch
