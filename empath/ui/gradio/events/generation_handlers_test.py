...
try:
    from empath.ui.gradio.events import generation_handlers
    from empath.ui.gradio.i18n import t as _t
    _IMPORT_ERROR = None
...
class GenerationHandlersTests(unittest.TestCase):
    ...
    @patch("empath.ui.gradio.events.generation.llm_analysis_actions.gr.Warning")
    @patch("empath.ui.gradio.events.generation.llm_analysis_actions.understand_music")
    def test_analyze_src_audio_rejects_non_audio_code_output(
        ...
        from empath.ui.gradio.i18n import t
        self.assertEqual(
            result,
    ...
    @patch("empath.ui.gradio.events.generation.service_init.get_global_gpu_config")
    @patch("empath.ui.gradio.events.generation.service_init.get_model_type_ui_settings")
    def test_init_service_wrapper_preserves_batch_size(
        ...
        gpu_config_mock.available_lm_models = ["empath-5Hz-lm-1.7B"]
    ...
    @patch("empath.ui.gradio.events.generation.validation.gr.Warning")
    @patch("empath.ui.gradio.events.generation.validation.soundfile.info")
    ...
    @patch("empath.ui.gradio.events.generation.llm_sample_actions.gr.Info")
    @patch("empath.ui.gradio.events.generation.llm_sample_actions.create_sample")
    ...
    @patch("empath.ui.gradio.events.generation.llm_format_actions.gr.Warning")
    ...
    @patch("empath.ui.gradio.events.generation.llm_format_actions.gr.Info")
    @patch("empath.ui.gradio.events.generation.llm_format_actions.format_sample")
...
class LoadMetadataLmCodesTests(unittest.TestCase):
    ...
    @patch("empath.ui.gradio.events.generation.metadata_loading.gr.Info")
    @patch("empath.ui.gradio.events.generation.metadata_loading.get_global_gpu_config")
