...
# --- LRC / VTT utilities -----------------------------------------------
from empath.ui.gradio.events.results.lrc_utils import (
...
from empath.ui.gradio.events.results.batch_queue import (
...
# --- scoring ------------------------------------------------------------
from empath.ui.gradio.events.results.scoring import (
    calculate_score_handler,
    calculate_score_handler_with_selection,
)

# --- audio transfer (remix / repaint / codes) ---------------------------
from empath.ui.gradio.events.results.audio_transfer import (
...
# --- generation progress ------------------------------------------------
from empath.ui.gradio.events.results.generation_progress import (
    generate_with_progress,
)

# --- batch management & AutoGen -----------------------------------------
from empath.ui.gradio.events.results.batch_management import (
    generate_with_batch_management,
    generate_next_batch_background,
)

# --- batch navigation ---------------------------------------------------
from empath.ui.gradio.events.results.batch_navigation import (
