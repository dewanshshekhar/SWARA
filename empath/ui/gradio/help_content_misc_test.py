...
from empath.ui.gradio.help_content_test_helpers import ensure_gradio_mocked

ensure_gradio_mocked()

from empath.ui.gradio.help_content import (  # noqa: E402
    HELP_MODAL_CSS,
    _next_id,
    create_help_button,
)
...
class CreateHelpButtonTests(unittest.TestCase):
    ...
    def test_create_help_button_calls_gr_html(self):
        ...
        mock_html = MagicMock()
        with patch("empath.ui.gradio.help_content.gr.HTML", return_value=mock_html) as mock_gr_html:
    ...
    def test_create_help_button_html_contains_modal(self):
        ...
        with patch("empath.ui.gradio.help_content.gr.HTML", side_effect=capture_html):
