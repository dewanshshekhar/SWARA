...
from empath.audio_utils import AudioSaver, generate_uuid_from_params, normalize_audio, get_lora_weights_hash
...
class GenerationParams:
    ...
    Attributes:
        ...
        vocal_language: Language code for vocals, e.g., "en", "zh", "ja", or "unknown". see empath/constants.py:VALID_LANGUAGES
...
def generate_music(
    ...
    """Generate music using Empath model with optional LM reasoning.
    
    Args:
        dit_handler: Initialized DiT model handler (EmpathHandler instance)
