...
from empath.api.train_api_models import StartLoKRTrainingRequest, initialize_training_state
from empath.api.train_api_runtime import RuntimeComponentManager, unwrap_module
...
def register_lokr_training_start_route(
    ...
    async def start_lokr_training(request: StartLoKRTrainingRequest, _: None = Depends(verify_api_key)):
        ...
        handler: EmpathHandler = app.state.handler
        ...
        try:
            from empath.training.configs import LoKRConfig as LoKRConfigClass, TrainingConfig
