...
language, instrumental = parse_description_hints("Lyric Pop Chinese")
    ...
    def test_get_model_name_normalizes_trailing_separators(self) -> None:
        ...
        self.assertEqual("empath-v15-turbo", get_model_name("empath-v15-turbo"))
        self.assertEqual("empath-v15-turbo", get_model_name("/models/empath-v15-turbo/"))
