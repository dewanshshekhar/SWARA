...
from empath.api.train_api_models import StartTrainingRequest, initialize_training_state
...
def register_lora_training_start_route(
    ...
    async def start_training(request: StartTrainingRequest, _: None = Depends(verify_api_key)):
        ...
        try:
            from empath.training.configs import LoRAConfig as LoRAConfigClass, TrainingConfig
