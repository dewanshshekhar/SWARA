...
Empath1.5 Rocm Manual for cachy-os and tested with RDNA4/Strix Halo.
...
#Navigate to the folder you want Empath to be in and open the terminal there
...
python -m empath.empath_v15_pipeline --server-name 0.0.0.0 --port 7680

#start the program local
python -m empath.empath_v15_pipeline --server-name 127.0.0.1 --port 7680
