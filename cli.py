...
def _configure_logging(
    ...
    if suppress_audio_tokens is None:
        suppress_audio_tokens = os.environ.get("EMPATH_SUPPRESS_AUDIO_TOKENS", "1") not in {"0", "false", "False"}
    if level is None:
        level = "INFO"
...
def _print_dit_prompt(dit_handler: "EmpathHandler", params: GenerationParams) -> None:
