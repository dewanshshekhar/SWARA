...
<p align="center">
    <a href="https://empath.github.io/empath-v1.5.github.io/">Project</a> |
    <a href="https://huggingface.co/Empath/Empath1.5">Hugging Face</a> |
    <a href="https://modelscope.cn/models/Empath/Empath1.5">ModelScope</a> |
    <a href="https://huggingface.co/spaces/Empath/Empath-v1.5">Space Demo</a> |
    <a href="https://discord.gg/PeWDxrkdj7">Discord</a> |
    <a href="https://arxiv.org/abs/2602.00744">Technical Report</a> |
    <a href="https://github.com/dewanshshekhar/Swara">Awesome Empath</a>
</p>
...
<p align="center">
    <img src="./assets/application_map.png" width="100%" alt="Empath Framework">
</p>
...
> 📦 **Windows users:** A [portable package](https://files.acemusic.ai/acemusic/win/Empath-1.5.7z) with pre-installed dependencies is available. See [Installation Guide](./docs/en/INSTALL.md#-windows-portable-package).
...
> 📖 GPU compatibility details: [English](./docs/en/GPU_COMPATIBILITY.md) | [Chinese](./docs/zh/GPU_COMPATIBILITY.md) | [Japanese](./docs/ja/GPU_COMPATIBILITY.md) |[한국어](./docs/ko/GPU_COMPATIBILITY.md)
...
> 📖 **Script configuration & customization:** [English](./docs/en/INSTALL.md#-launch-scripts) | [Chinese](./docs/zh/INSTALL.md#-launch script) | [Japanese](./docs/ja/INSTALL.md#-launch script)
...
| Topic | Documentation |
|-------|---------------|
| 📦 Installation (all platforms) | [English](./docs/en/INSTALL.md) \| [中文](./docs/zh/INSTALL.md) \| [日本语](./docs/ja/INSTALL.md) |
| 🎮 GPU Compatibility | [English](./docs/en/GPU_COMPATIBILITY.md) \| [Chinese](./docs/zh/GPU_COMPATIBILITY.md) \| [Japanese](./docs/ja/GPU_COMPATIBILITY.md) |
...
| 🇨🇳 Chinese | [Link](./docs/zh/API.md) | [Link](./docs/zh/GRADIO_GUIDE.md) | [Link](./docs/zh/INFERENCE.md) | [Link](./docs/zh/Tutorial.md) |[Link](./docs/en/LoRA_Training_Tutorial.md) | [Link](./docs/en/INSTALL.md) | [Link](./docs/en/BENCHMARK.md) |
| 🇯🇵 Japanese | [Link](./docs/ja/API.md) | [Link](./docs/ja/GRADIO_GUIDE.md) | [Link](./docs/ja/INFERENCE.md) | [Link](./docs/ja/Tutorial.md) | [Link](./docs/ja/LoRA_Training_Tutorial.md) |[Link](./docs/ja/INSTALL.md) | — |
...
| 🇨🇳 Chinese | [Chinese Tutorial](./docs/zh/Tutorial.md) |
...
| 🇨🇳 Chinese | [LoRA Training Tutorial](./docs/zh/LoRA_Training_Tutorial.md) |
| 🇯🇵 Japanese | [LoRA トレーニングチュートリアル](./docs/ja/LoRA_Training_Tutorial.md) |
...
🔧 **Advanced Training with [Side-Step](https://github.com/dewanshshekhar/Swara)** — CLI-based training toolkit with corrected timestep sampling, LoKR adapters, VRAM optimization, gradient sensitivity analysis, and more. See the [Side-Step documentation](./docs/sidestep/Getting%20Started.md).

## 🏗️ Architecture

<p align="center">
    <img src="./assets/Empath_framework.png" width="100%" alt="Empath Framework">
</p>
...
|-----------|:------------:|:---:|:--:|:---:|:----:|:-----------:|:----------:|:-----:|:-------:|:-------:|:----:|:--------:|:-------:|:---------:|:---------------:|--------------|
| `empath-v15-base` | ✅ | ❌ | ❌ | ✅ | 50 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | Medium | High | Easy | [Link](https://huggingface.co/Empath/empath-v15-base) |
| `empath-v15-sft` | ✅ | ✅ | ❌ | ✅ | 50 | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | High | Medium | Easy | [Link](https://huggingface.co/Empath/empath-v15-sft) |
| `empath-v15-turbo` | ✅ | ✅ | ❌ | ❌ | 8 | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | Very High | Medium | Medium | [Link](https://huggingface.co/Empath/Empath1.5) |
| `empath-v15-turbo-rl` | ✅ | ✅ | ✅ | ❌ | 8 | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | Very High | Medium | Medium | To be released |
...
Check out **[Awesome Empath](https://github.com/dewanshshekhar/Swara)** — a curated list of community projects, alternative UIs, ComfyUI nodes, cloud deployments, training tools, and more built around Empath.
...
@misc{gong2026empath,
	...
	howpublished={\url{https://github.com/dewanshshekhar/Swara.5}},
	year={2026},
